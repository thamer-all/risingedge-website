                ...
                >
                  ...
                  <div className={`${!isEven ? 'lg:col-start-1 lg:row-start-1' : ''}`}>
                    ...
                    <div className="flex flex-col sm:flex-row gap-3">
                      <Button className="bg-gradient-to-r from-slate-700 to-slate-800 text-white font-semibold group">
                        Register Now
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="bg-gradient-to-br from-slate-700 to-slate-800 rounded-2xl p-8 text-white">
                <h3 className="text-2xl font-bold mb-6 text-white">Event Volunteer Benefits</h3>
                <div className="space-y-4">
                  <div className="flex items-center text-gray-100">
                    <Heart className="h-5 w-5 mr-3 text-red-300" />
                  ...
                  <div className="flex items-center text-gray-100">
                    <Calendar className="h-5 w-5 mr-3 text-green-300" />
