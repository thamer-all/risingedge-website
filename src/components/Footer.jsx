...
const Footer = () => {
  ...
  const getInvolved = [
    { name: 'Volunteer Application', href: '/volunteer' },
    { name: 'Corporate Partnerships', href: '/partner' },
  ...
  const socialLinks = [
    ...
    { icon: Linkedin, href: 'https://linkedin.com/company/risingedgecommunity', label: 'LinkedIn' }
  ];
