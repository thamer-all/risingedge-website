    ...
    <section id="programs" ref={sectionRef} className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              >
                ...
                <div className="flex-1 space-y-6">
                  ...
                  <Button 
                    ...
                    onClick={() => window.location.href = `/${program.title.toLowerCase()}`}
                  >
                    Learn More
        ...
        <div className="text-center mt-20">
          <div className="bg-gradient-to-r from-emerald-600 to-orange-600 rounded-2xl p-8 text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button 
                size="lg" 
                className="bg-white text-slate-800 hover:bg-gray-100 hover:text-slate-900 font-semibold shadow-lg transition-all duration-300"
              ...
              <Button 
                size="lg" 
                variant="outline" 
                className="border-2 border-white text-white hover:bg-white hover:text-slate-800 font-semibold shadow-lg transition-all duration-300"
