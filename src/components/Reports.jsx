        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            {reports.map((report, index) => (
              ...
              >
                {report.featured && (
                  <div className="bg-gradient-to-r from-slate-700 to-slate-800 text-white text-center py-2 text-sm font-semibold">
                    Featured Report
                  </div>
                )}
                ...
                <div className="p-6">
                  ...
                  <Button className="w-full bg-gradient-to-r from-slate-700 to-slate-800 text-white font-semibold group">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="bg-gradient-to-br from-slate-700 to-slate-800 rounded-2xl p-8 text-white">
                <h3 className="text-2xl font-bold mb-6 text-white">Our Accountability Promise</h3>
                <div className="space-y-6">
                  <div className="text-center">
                    <div className="text-4xl font-bold mb-2 text-white">100%</div>
                    <div className="text-gray-100">Financial Transparency</div>
                  </div>
                  <div className="text-center">
                    <div className="text-4xl font-bold mb-2 text-white">Annual</div>
                    <div className="text-gray-100">Impact Reporting</div>
                  </div>
                  <div className="text-center">
                    <div className="text-4xl font-bold mb-2 text-white">Open</div>
                    <div className="text-gray-100">Data Access</div>
                  </div>
                </div>
              </div>
            </motion.div>
